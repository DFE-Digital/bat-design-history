 ...
 *   }
 */
function buildNavigationMap (collection) {
 ...
 */
function getBreadcrumbs (navMap, key) {
  if (!navMap || !key) {
    return []
  }
 ...
 */
function getNavigationChildren (navMap, key) {
  if (!navMap || !key) {
    return []
  }
 ...
 */
function navigationToHtml (children, options = {}) {
