---
title: Improving how we ask candidates about their availability for interviews
...
ogImage:
  ...
  alt: "Illustration showing a task list with a section called 'Interview availability' the next screen shows the question asking candidates if the have any times they are not available for interviews. The candidates can acnswer 'Yes' or 'No'."
---

![Illustration showing a task list with a section called 'Interview availability' the next screen shows the question asking candidates if the have any times they are not available for interviews. The candidates can acnswer 'Yes' or 'No'.](interview-availability-cover.png)
