...
{{ appFigure({
  image: {
    ...
    alt: "Deadline notification banner on application menu."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "Interstitial page is shown on sign in."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "Notification banner on application menu."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "‘Review’ section of application menu."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "Message shown in ‘Courses’ section of application menu."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "Message shown in ‘Courses’ section of application review page."
  }
}) }}
...
{{ appFigure({
  image: {
    ...
    alt: "Prompt to apply again on the application dashboard."
  }
}) }}
