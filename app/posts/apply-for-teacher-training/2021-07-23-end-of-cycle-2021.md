...
{{ appFigure({
  ...
  caption: "Candidates get the usual email inviting them to apply again in the same recruitment cycle."
}) }}
...
{{ appFigure({
  ...
  caption: "If they log in before the deadline to apply again, they'll see the usual message about applying again this year, but with the addition of the deadline banner."
}) }}
