...
- 25% of eligible candidates (7,597 candidates in total) did not get any offers
...
- either did not need a visa, or the course sponsored a visa
...
Our reapplication rate indicates that candidates do not always know which courses to apply to initially. This leads to repeated unsuccessful outcomes when they select a route or course that is not a good fit.
...
- Drawbacks:
  - Potential for confusion with our existing recruitment process, candidates could think that they do not need to find and apply for courses themselves if they engage with this
