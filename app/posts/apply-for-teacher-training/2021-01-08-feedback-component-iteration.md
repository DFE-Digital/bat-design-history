...
Whilst we could fix this adding the word "(optional)" to the legend and label, this would be a bit odd as it does not really make sense for a user to not tick any of the checkboxes or provide any written feedback.
