...
We have heard from research and support queries that training providers are receiving a high volume of applications from international candidates which they end up rejecting because applicants have not fully understood some important information such as:
...
However the last round of research was in March 2023, so we wanted to understand whether this was a persistent problem.

### Is this still a problem - do we still have the same level of international applications?

Yes, 48.8k (44%) in the 2024 to 2025 recruitment cycle, 48.2k (46%) in the 2023 to 2024 cycle.

Rejections are 25% higher for international candidates than domestic.

### Have we resolved any of these issues?

Visa sponsorship as a rejection reason for international candidates is down by half in the 2024 to 2025 recruitment cycle.
...
### Qualifications
This is the biggest rejection reason for international candidates (42.89% of all rejections in the 2024 to 2025 cycle.) Whilst ‘supporting documents not provided’ is reasonably small at only 2.67%, this is 140% higher than for domestic candidates.

### Ways to find out more
We wanted to direct people to more information about anything that they’ve read on the ‘check before you send’ page so that they can give themselves the best chance of applying to the right course the first time they try.
...
There were other ideas in this piece of work that we haven’t made live yet. These are:

Make it clearer who needs an English as a foreign language assessment

updating the English as a foreign language question flow
