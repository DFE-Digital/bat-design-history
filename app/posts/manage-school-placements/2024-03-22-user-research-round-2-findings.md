...
We spoke to six initial teacher training (ITT) providers responsible for identifying placement opportunities and/or matching trainees to placement schools and mentors.
...
- 2 paired sessions to get the perspective of different roles within the same ITT provider – meaning we spoke to 8 participants in total across the 6 research sessions with ITT providers
...
We tested the first iteration of the ‘find a placement’ journey and got general feedback on the overall service and its value to ITT providers – building on the prototype produced as part of the Alpha phase.
...
Searching based on a trainee's location was the most common scenario for which participants could see themselves using the service. Placements need to be a ‘reasonable commute’ for the trainee, and this often significantly limits the available options, so location is the first criterion used to narrow down the options.
...
The tested prototype only allowed participants to search based on straight-line distances. Still, ITT providers would need to check the travel time by car or public transport, depending on the trainee's personal circumstances, so anything that can support or remove this separate task would be valuable.
...
There are some gaps to address but the current placement information provides most of what ITT providers need as a minimum at the initial enquiry stage – although further work is required to prioritise the most important information visually.

#### Supporting detail and evidence

Key stage and school size information are important for primary school placements as they can be used to determine whether the placement suits the trainee or to ensure sufficient contrast between a first and second placement.
...
As also identified in previous research with placement schools, an extra level of detail is needed for certain Secondary subjects like design and technology to know which specific subject is being offered (food technology, resistant materials, etc.).

On the placement details screen, the placement point of contact should be nearer the top of the screen as this was the first thing participants looked for, with contrast factor related information made into a clearer section lower down as it's used less frequently and the purpose of that information was not always clear.
...
ITT providers manage a network of partner schools and will prioritise opportunities in schools they have an existing relationship where possible. However, based on the current prototype design, participants were unclear on the benefit they would get from adding these relationships into the service. They also felt that this service would be most useful when searching for placements outside their partner network, so it did not make sense to have the placements on the Placements tab filtered only to show placements from partner schools as the default.

When adding a partner school, ITT providers expected that schools should be notified and have control over who is their ‘partner’. However, there was concern about a grey area where it's difficult to say whether the school is or is not a ‘partner’ – for example, if the ITT provider placed a trainee at that school multiple years ago and has not again since. Some schools would be ‘partners’ (the school and the ITT provider work together regularly and there's a partnership agreement in place), but there can be varying levels of partnership in between.

## Hypotheses to test in future research

### Hypothesis 1

We think that schools will likely need the service to prompt them to keep their placement information up to date.

We think this because getting placement information from schools can currently require numerous reminders from ITT providers.

We will test this by seeing if participants in future research rounds react positively to additional features that support schools in keeping their placement information up to date.

### Hypothesis 2

We think that having the Placements tab filters update the available options dynamically based on other filters that have been selected, to avoid showing irrelevant options, will help streamline the experience of finding a placement.
...
We will test this by seeing if the addition of dynamic filters avoids this confusion in future research rounds.

### Hypothesis 3

We think that school type, gender, religious character and Ofsted rating might not be needed as filter options on the Placements tab.
...
We will test this by seeing if participants in future research rounds mention the need for these filters when shown a version of the prototype without them.
