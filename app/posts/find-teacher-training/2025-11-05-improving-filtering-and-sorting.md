...
In our research, Candidates on mobile phones did not notice ‘show filters’ option until it was pointed out.
...
<img alt="Screenshot of the live site on a mobile with the filter panel open displaying the ways to filter courses." src="live-site-filters-panel.png" style="width:50%;">
...
<img alt="Screenshot of the section of the search results page on the protoype with one link to a guidance page on the Get Into Teaching website." src="git-links-prototype.png" style="width:50%;">
