...
The following email was sent to Publish users in June. ([Notify link](https://www.notifications.service.gov.uk/services/022acc23-c40a-4077-bbd6-fc98b2155534/templates/22946b68-92e9-4205-a3c0-f0c5628fb7eb))

{{ appEmail({
  subject: "Information about your teacher training courses for 2021 – 2022",
  content: "Dear colleague,

We’re writing to you about your courses for the 2021 – 2022 academic year, which will appear on [Find postgraduate teacher training](https://www.find-postgraduate-teacher-training.service.gov.uk/) in October. This email sets out what you need to do over the next few months to prepare your courses for the new cycle.
...
The following email was sent to Publish users in July. ([Notify link](https://www.notifications.service.gov.uk/services/022acc23-c40a-4077-bbd6-fc98b2155534/templates/901ee5cd-c524-4588-96ce-478f1d003997))

{{ appEmail({
  subject: "Review and publish your courses for 2021 – 2022",
  content: "Dear colleague,

Last month we wrote to you about your courses for the 2021 to 2022 academic year. We told you that we were shortly going to start the ‘rollover’ process – duplicating all your current content in [Publish teacher training courses](https://www.publish-teacher-training-courses.service.gov.uk/).
...
The following email was sent to Publish users in September. ([Notify link](https://www.notifications.service.gov.uk/services/022acc23-c40a-4077-bbd6-fc98b2155534/templates/7ebed1e2-b8a9-4da7-968f-d3df302f5219))

{{ appEmail({
  subject: "New recruitment cycle for the 2021 to 2022 academic year",
  content: "Dear colleague,
...
The current recruitment cycle ends on 3 October 2020. Any existing courses will be removed from [Find postgraduate teacher training](https://find-postgraduate-teacher-training.education.gov.uk) on this date.
...
The following email was sent to Publish users in October. ([Notify link](https://www.notifications.service.gov.uk/services/022acc23-c40a-4077-bbd6-fc98b2155534/templates/0e311d43-c450-4eb5-894b-544dd92ef735))

{{ appEmail({
  subject: "2021 to 2022 cycle opening tomorrow on Find",
  content: "Dear colleague,
...
This email was sent was sent to providers after the new cycle was launched. ([Notify link](https://www.notifications.service.gov.uk/services/022acc23-c40a-4077-bbd6-fc98b2155534/templates/2f91cd7f-ea21-4ef9-98c9-e18f2800b54b))
